---
name: qa-tester
description: Use this skill to create manual QA checklists, regression tests, compatibility tests, and release validation plans for Disaster Command Center.
---
