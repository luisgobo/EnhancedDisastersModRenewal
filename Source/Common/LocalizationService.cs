        ...
        {
            {
                ModLanguage.English, new Dictionary<string, string>
                {
                    ...
                    ["panel.tooltip"] = "Drag with right-click to move this panel",
                    ...
                    ["settings.realTimeTsunamiSpeed"] = "Real Time tsunami speed",
                    ...
                    ["settings.realTimeMeteorFrequency"] = "Real Time meteor rate",
                    ...
                    ["settings.tooltip.realTimeTsunamiSpeed"] = "Accelerates tsunami build-up and cooldown only while Real Time is active.",
                    ...
                    ["settings.tooltip.realTimeMeteorFrequency"] = "Accelerates the meteor approach cycle only while Real Time is active.",
            ...
            },
            {
                ModLanguage.Spanish, new Dictionary<string, string>
                {
                    ...
                    ["panel.tooltip"] = "Arrastre con clic derecho para mover este panel",
                    ...
                    ["settings.realTimeTsunamiSpeed"] = "Velocidad de tsunami con Real Time",
                    ...
                    ["settings.realTimeMeteorFrequency"] = "Ritmo de meteoritos con Real Time",
                    ...
                    ["settings.tooltip.realTimeTsunamiSpeed"] = "Acelera la preparacion y el enfriamiento del tsunami solo cuando Real Time esta activo.",
                    ...
                    ["settings.tooltip.realTimeMeteorFrequency"] = "Acelera el ciclo de aproximacion de meteoritos solo cuando Real Time esta activo.",
