...
namespace NaturalDisastersRenewal.UI
{
    public class NewSettingsScreen
    {
        ...
        private readonly string evacuationModeText = "Evacuation Mode: ";
        ...
        public void BuildSettingsMenu(UIHelper helper)
        {
            ...
            TabHelper tabHelper = TabHelper.Create(helper);

            // Agregar pestañas y contenido
            UIHelper generalContent = tabHelper.AddTabPage("General");
            SetupGeneralTab(ref generalContent, disasterContainer);

            //UIHelper forestFireContent = tabHelper.AddTabPage("Forest Fire");
            //SetupForestFire(ref forestFireContent, disasterContainer);

            //UIHelper thunderstormContent = tabHelper.AddTabPage("Thunderstorm");
            //SetupThunderstorm(ref thunderstormContent, disasterContainer);

            //UIHelper sinkholeContent = tabHelper.AddTabPage("Sinkhole");
            //SetupSinkhole(ref sinkholeContent, disasterContainer);

            //UIHelper tornadoContent = tabHelper.AddTabPage("Tornado");
            //SetupTornado(ref tornadoContent, disasterContainer);

            //UIHelper tsunamiContent = tabHelper.AddTabPage("Tsunami", true);
            //SetupTsunami(ref tsunamiContent, disasterContainer);

            //UIHelper earthquakeContent = tabHelper.AddTabPage("Earthquake", true);
            //SetupEarthquake(ref earthquakeContent, disasterContainer);

            //UIHelper meteorStrikeContent = tabHelper.AddTabPage("Meteor Strike", true);
            //SetupMeteorStrike(ref meteorStrikeContent, disasterContainer);

            //UIHelper saveOptionsContent = tabHelper.AddTabPage("Save Options", true);
            //SetupSaveOptions(ref saveOptionsContent, disasterContainer);
