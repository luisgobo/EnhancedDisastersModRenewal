---
name: ux-designer
description: Design the user experience, information architecture, and player flow for the Disaster Command Center configuration UI. Use when an agent needs to plan dashboards, tabs, basic versus advanced settings, tooltips, warning text, compatibility flows, disaster intensity explanations, emergency controls, or migration from the legacy Source/ UI.
---
