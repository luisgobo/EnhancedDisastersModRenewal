...
description: Convert Steam comments, user feedback, bug reports, feature ideas, and developer notes into prioritized roadmap items for Disaster Command Center. Use when an agent needs to classify feedback, plan migration parity from the legacy Source/ implementation, prepare GitHub issue candidates, or decide whether requests belong in disaster behavior, configuration, compatibility, UI, QA, release, or documentation work.
---
