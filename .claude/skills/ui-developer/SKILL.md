---
name: ui-developer
description: Convert UI and UX plans into implementation-oriented technical guidance for a Cities: Skylines 1 C# mod. Use when an agent needs to plan C# UI class structure, panels, tabs, helpers, adapters, settings bindings, compatibility status surfaces, or small migration steps from the legacy Source/ UI while respecting .NET Framework 3.5 and Unity-era limits.
---
